		...
		<aside class="sidebar">
			...
			<nav class="sidebar-nav">
				<ul class="nav-list">
					...
					<li class="nav-item"><a href="relatorios.php" class="nav-link"><i class="fas fa-chart-bar"></i><span>Relatórios</span></a></li>
					<li class="nav-item"><a href="configuracoes.php" class="nav-link active"><i class="fas fa-cog"></i><span>Configurações</span></a></li>
				</ul>
			</nav>
		...
		<main class="main-content">
			<header class="main-header">
				<div class="header-left">
					...
					<p class="page-subtitle">Personalize sua experiência e preferências do sistema</p>
				</div>
			</header>
			...
			<section class="settings-grid">
				<div class="settings-card">
					...
					<div class="form-group">
						<label for="languageSelect">Idioma do sistema</label>
				...
				<div class="settings-card">
					...
					<div class="form-group">
						<button class="btn btn-primary" id="saveAccountBtn">Salvar alterações</button>
					</div>
				</div>
			</section>
		</main>
